...
The lead photo must be a clear, well-lit shot of the user's face. The ideal lead is: solo, candid (not posed stiffly), natural lighting, full color (not B&W), and not a selfie. The user should be the only subject, or clearly the dominant subject, looking comfortable and themselves. Flag any lead photo that violates these: a selfie, a group shot, a B&W photo, a photo where the face is partially obscured, a photo taken from too far away to read the face, or a photo where the user blends into the background. The lead photo alone drives the first scroll-stop decision — it is the most important real estate on the entire profile.
